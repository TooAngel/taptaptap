 ...
 * @param {func} callback
 */
function InitTapTapTapGame(callback) {
 ...
 * TapTapTapGame
 */
function TapTapTapGame() {
  // ---------------------- Pages ---------------------- //

  // Splash Page
  const pageSplash = document.querySelector('#pageSplash');
  // --
  const splashScreenTxt = document.querySelector('#splashScreenTxt');
  const splashScreenLogo = document.querySelector('#splashScreenLogo');


  // Play Delay Page
  const pagePlayDelay = document.querySelector('#pagePlayDelay');
  // --
  const playDelayNum = document.querySelector('#playDelayNum');


  // Play Area Page
  const pagePlayArea = document.querySelector('#pagePlayArea');
  // --
  const gmStatsTimeProgress = document.querySelector('#gmStatsTimeProgress');
  const gmStatsScore = document.querySelector('#gmStatsScore');
  const gmStatsLvlNumb = document.querySelector('#gmStatsLvlNumb');
  const gameSpace = document.querySelector('#gameSpace');
  const gmStatsCurrentTapCount = document.querySelector('#gmStatsCurrentTapCount');
  const gmStatsTotalTapCount = document.querySelector('#gmStatsTotalTapCount');


  // Level passed page
  const pageLevelPassed = document.querySelector('#pageLevelPassed');
  // --
  const lvlPssdScore = document.querySelector('#lvlPssdScore');
  const lvlPssdBonusScore = document.querySelector('#lvlPssdBonusScore');
  const lvlPssdContinueNextLvlBtn = document.querySelector('#lvlPssdContinueNextLvlBtn');


  // You lost page
  const pageYouLost = document.querySelector('#pageYouLost');
  // --
  const lvlLostScore = document.querySelector('#lvlLostScore');
  const lvlLostTtl = document.querySelector('#lvlLostTtl');
  const lvlLostTryAgainBtn = document.querySelector('#lvlLostTryAgainBtn');
  const lvlLostIcon = document.querySelector('#lvlLostIcon');
  ...
  toolsBox = {
    ...
    pageAbout: {
      ...
      moveCredits: function() {
        const creditsCont = toolsBox.pageAbout.creditsCont;
  ...
  const circlesEngine = {
    ...
    // Chcek if that kind of circle exists & delete them
      ...
      if (numOfCircles) { // check if there's a number of circles, else create 1 only
        for (let i = 0; i < numOfCircles; i++) { // create and throw in random positions
  ...
  const audioPool = {
    ...
    // Create a player for each  sound
      for (let i = 0; i < audioPool.sounds.length; i++) {
...
module.exports.TapTapTapGame = TapTapTapGame;
